...
> - **No longer do you need to be aware of release dates**- The system will automatically compare what is coming soon against your flight path history and adjust to accommodate.
...
Glidearr is released under the **GNU Affero General Public License v3.0** — see [`LICENSE`](LICENSE). AGPL keeps Glidearr open: anyone who runs a modified version — including as a hosted or networked service — must make their source available under the same terms.
