...
_DOC_LEAVES = [
    ...
    ("pilot_best_tier_first.enabled", "true", "Pilot search targets the highest tier that fits the space reserve, diverting down; false = legacy floor-first"),
    ("pilot_best_tier_first.force_floor", "false", "Grab the pilot at the floor even when no tier fits the reserve (vs skip + re-probe). Pilots are never deleted"),
    ...
    ("documentaryGenres", "documentary,reality,nature", "Comma-separated genre list"),
