...
_DOC_LEAVES = [
    ...
    ("rootFolders.series", "/data/media/tv/series", "TV bucket folder (series/anime/kids/documentary/reality)"),
    ("rootFolders.anime", "/data/media/tv/anime", ""),
    ("rootFolders.kids", "/data/media/tv/kids", ""),
    ("rootFolders.documentary", "/data/media/tv/documentaries", ""),
    ("rootFolders.reality", "/data/media/tv/reality", ""),
    ...
    ("plex.playlists.kids_age_max", "11", "AGE GATE FOR THE KIDS LIBRARY. The oldest Common Sense Media recommended age that still counts as 'kids': a title CSM rates ABOVE this is routed OUT of the kids folder, while a low or absent CSM age never routes one IN on its own (it must also carry a kids genre, a kids network, or a kid-safe certificate). 11 = the oldest genuine Pixar/Disney animation; lower it for younger children (8 keeps tween content out), raise it for older ones. Range 2-17; anything outside is REFUSED with a warning and falls back to 11, because silently widening a parental gate is the wrong way to fail"),
