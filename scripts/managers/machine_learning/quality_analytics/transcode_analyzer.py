"""quality_analytics/transcode_analyzer.py — transcode penalty.
==============================================================================
...
PURPOSE: Score the transcode burden of a profile/device pairing.

PULLS FROM (decision cores to migrate here):
  - machine_learning/transcode_analyzer.py (decision half)

PUBLIC API (to implement):
  - transcode_penalty(profile, device_caps) -> float

DEPENDS ON: contracts
SERVICE REMAINDER (stays in the service as the thin adapter): Service supplies device caps (FETCH).
"""
